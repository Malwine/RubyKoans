...
class AboutClasses < Neo::Koan
  ...
  def test_args_to_new_must_match_initialize
    ...
    # THINK ABOUT IT:
    # Why is this so?
    # The initialize method is called automatically,
    # when it is implemented and a new object is created.
    # So there will be an ArgumentError because it was called without an arument.
  end
