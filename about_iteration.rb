...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject is called with an argument and a block.
    # The first time the block is executed the value is going to be the given argument.
    # Then the block continues to execute with the elements in the Array.
  end
